...
def main():
    csv_file = './step5_lp_lg_detect.csv'  # Update the path if the CSV is in a different directory
    ...
    out = cv2.VideoWriter('./step5_lp_lg_detect.avi', fourcc, 20.0, (int(cap.get(3)), int(cap.get(4))))
